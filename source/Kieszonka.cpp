...
Turret* get_turret2() {
	...
	sf::RectangleShape* shape = new sf::RectangleShape(sf::Vector2<float>(32,32));
	shape->setTexture(texture);
	return new Turret(Cell::TURRET,shape,150,Color::BLUE);
}
Turret* get_turret3() {
	sf::Texture* texture = new sf::Texture();
	...
	sf::RectangleShape* shape = new sf::RectangleShape(sf::Vector2<float>(32,32));
	shape->setTexture(texture);
	return new Turret(Cell::TURRET,shape,150,Color::RED);
}
Turret* get_turret4() {
	sf::Texture* texture = new sf::Texture();
	...
	sf::RectangleShape* shape = new sf::RectangleShape(sf::Vector2<float>(32,32));
	shape->setTexture(texture);
	return new Turret(Cell::TURRET,shape,150,Color::GREEN);
}
