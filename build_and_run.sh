...
g++ -std=c++11 build/main.o build/Cell.o build/Background.o build/Bullet.o build/FinderCatalog.o build/Turret.o build/ObjectStorage.o build/BG_Builder.o build/Enemy.o \
